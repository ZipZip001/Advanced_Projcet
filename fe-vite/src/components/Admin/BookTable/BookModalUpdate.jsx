...
import { callUpdateBookOut,callCategoryOut } from '../../../services/api';
...
const BookModalUpdate = (props) => {
    ...
    const onFinish = async (values) => {
        ...
        setIsSubmit(true);
        const res = await callUpdateBookOut(thumnail, maintext, category, author, price,quantity);


            message.success('Cập nhất sách thành công');
